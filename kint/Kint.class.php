...
if ( !function_exists( 'd' ) ) {
	...
	function d()
	{
		 ...
		 * Added this condtional for  show debug only in development instances
		 * @since  November 8, 2016
		*/
		if(strcmp($_SERVER["SERVER_NAME"], "localhost")==0 || strcmp($_SERVER["SERVER_ADDR"], "127.0.0.1")==0 || strcmp($_SERVER["SERVER_ADDR"], "172.16.36.5")==0 || strcmp($_SERVER["SERVER_ADDR"], "172.16.36.10")==0){

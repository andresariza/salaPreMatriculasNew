...
function salaAutoloader($nombreClase){
    ...
    switch ($nombreClase){
        case ($nombreClase == $controlClass):
            require_once (PATH_SITE.'/components/'.$option.'/control/'.$controlClassFile.'.php');            //
            break;
        case ($nombreClase == $modeloClass):
            require_once (PATH_SITE.'/components/'.$option.'/modelo/'.$modeloClassFile.'.php');
            break;
        ...
        case "Sala\control\ControlRender":
            ...
            break;
        case "Configuration":
            require_once (PATH_SITE.'/config/Configuration.php');
            break;
        default:

...
use \Sala\entidad\EstadoPeriodo;
use \Sala\entidad\Periodo;
use \Sala\entidad\PeriodosVirtuales;
/**
 * @author Andres Ariza <arizaandres@unbosque.edu.do>
 * @copyright Universidad el Bosque - Dirección de Tecnología
 * @package entidad
*/
class PeriodoVirtualCarrera implements \Sala\interfaces\Entidad{
    /**
     * @type adodb Object
     * @access private
     */
    ...
    public function setPeriodo() {
        if(!empty($this->codigoPeriodo)){
            $this->Periodo = new \Sala\entidad\Periodo();
            $this->Periodo->setDb();
    ...
    public function setPeriodoVirtual() {
        if(!empty($this->idPeriodoVirtual)){
            $this->PeriodoVirtual = new \Sala\entidad\PeriodosVirtuales();
    ...
    public function setEstadoPeriodo() {
        if(!empty($this->codigoEstadoPeriodo)){
            $this->EstadoPeriodo = new \Sala\entidad\EstadoPeriodo();

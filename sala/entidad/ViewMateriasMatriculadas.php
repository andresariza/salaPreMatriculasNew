...
class ViewMateriasMatriculadas implements \Sala\interfaces\Entidad{
    /**
     * @type adodb Object
     * @access private
     */
    ...
    public function setDetallePrematricula(){
        if(!empty($this->idDetallePrematricula)){
            $this->DetallePrematricula = new \Sala\entidad\DetallePreMatricula();
    ...
    public function setPrematricula() {
        if(!empty($this->idprematricula)){
            $this->Prematricula = new \Sala\entidad\Prematricula();

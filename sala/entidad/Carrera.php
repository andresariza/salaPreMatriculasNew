 ...
 * @package entidad
*/
class Carrera implements \Sala\interfaces\Entidad{
    /**
     * @type adodb Object
     * @access private
     */
...
`codigocarrera` int(11) NOT NULL AUTO_INCREMENT,
  `codigocortocarrera` varchar(15) NOT NULL DEFAULT '',
  `nombrecortocarrera` varchar(100) NOT NULL,
  `nombrecarrera` varchar(100) NOT NULL DEFAULT '',
  `codigofacultad` varchar(4) NOT NULL DEFAULT '',
  `centrocosto` varchar(15) NOT NULL DEFAULT '',
  `codigocentrobeneficio` varchar(20) NOT NULL DEFAULT '0',
  `codigosucursal` char(2) NOT NULL DEFAULT '',
  `codigomodalidadacademica` char(3) NOT NULL DEFAULT '',
  `fechainiciocarrera` datetime NOT NULL DEFAULT '1980-01-01 00:00:00',
  `fechavencimientocarrera` datetime NOT NULL DEFAULT '9999-12-01 00:00:00',
  `abreviaturacodigocarrera` varchar(5) NOT NULL DEFAULT '',
  `iddirectivo` int(11) NOT NULL DEFAULT '0',
  `codigotitulo` int(11) NOT NULL DEFAULT '0',
  `codigotipocosto` char(3) NOT NULL DEFAULT '',
  `codigoindicadorcobroinscripcioncarrera` char(3) NOT NULL DEFAULT '',
  `codigoindicadorprocesoadmisioncarrera` char(3) NOT NULL DEFAULT '',
  `codigoindicadorplanestudio` varchar(3) NOT NULL,
  `codigoindicadortipocarrera` varchar(3) NOT NULL,
  `codigoreferenciacobromatriculacarrera` varchar(3) NOT NULL,
  `numerodiaaspirantecarrera` smallint(6) NOT NULL,
  `codigoindicadorcarreragrupofechainscripcion` varchar(3) NOT NULL,
  `codigomodalidadacademicasic` char(3) NOT NULL DEFAULT '000',
  `EsAdministrativa` tinyint(1) DEFAULT NULL,
/**/
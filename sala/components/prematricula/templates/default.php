...
echo Sala\lib\Factory::printImportJsCss("js",HTTP_SITE."/components/prematricula/assets/js/manejoDeSortable.js");
echo Sala\lib\Factory::printImportJsCss("js",HTTP_SITE."/components/prematricula/assets/js/manejoDeCreditos.js");
echo Sala\lib\Factory::printImportJsCss("js",HTTP_SITE."/components/prematricula/assets/js/manejoDeGruposYHorarios.js");
echo Sala\lib\Factory::printImportJsCss("js",HTTP_SITE."/components/prematricula/assets/js/manejoDeMaterias.js");
echo Sala\lib\Factory::printImportJsCss("js",HTTP_SITE."/components/prematricula/assets/js/manejoDeCuposYReservas.js");
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 text-right">
                <button id="finalizarPrematricula" class="btn btn-lg btn-success btn-labeled fa fa-save" disabled >Finalizar y Guardar Prematricula</button>
            </div>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="panel-heading">
                    <div class="panel-control">
                        <button class="btn btn-primary btn-labeled fa fa-eye previsualizarFinal" data-target="#preview-lg-modal" data-toggle="modal">Ver Horarios Seleccionados</button>
                    </div>

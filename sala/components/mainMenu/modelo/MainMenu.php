<?php
namespace Sala\components\mainMenu\modelo;
defined('_EXEC') or die;
use \Sala\lib\ModMainMenuHelper;
 ...
 * @package model
 */
class MainMenu implements \Sala\interfaces\Model{
    /**
     * @type adodb Object
     * @access private
     */
    ...
    public function getVariables($variables){
        ...
        if($menuEstudiante===false){
            ...
            $i = implode(",", $items);
            $array['menuEstudiante'] = \Sala\entidad\MenuBoton::getList(" idmenuboton IN (".$i.") ");
    ...
    public static function getLinkBotonValores(){
        ...
        $numerocohorte = \Sala\modelo\Cohorte::getNumeroCohorte($codigoperiodo, $codigoestudiante);
        //dddd($numerocohorte);
        ...
        $CalculoCreditosSemestre = new \Sala\modelo\CalculoCreditosSemestre();

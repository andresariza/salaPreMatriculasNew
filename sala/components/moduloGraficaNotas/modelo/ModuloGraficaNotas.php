<?php
namespace Sala\components\moduloGraficaNotas\modelo;
/**
...
class ModuloGraficaNotas implements \Sala\interfaces\Model{
    /**
     * @type adodb Object
     * @access private
     */
        ...
        switch($variables->layout){
            ...
            case "notasMateriasPosgrado":
                ...
                if($idPerfil == 1){
                    ...
                    $array["PeriodoActual"] = new \Sala\entidad\Periodo();
    ...
    private function getHistoricoNotas(){
        ...
        $datos = \Sala\entidad\ViewHistoricoNotasEstudiante::getList($where);

            ...
            <tbody>
                ...
                foreach($StreamingActividadesBienestar as $m){
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo \Sala\components\moduloActividadesBienestar\control\ControlModuloStreamingActividadesBienestar::printInconEstado($m->getCodigoEstado(), $m->getId());?>
                        </td> 
                        <td>
                            <?php echo \Sala\components\moduloActividadesBienestar\control\ControlModuloStreamingActividadesBienestar::printInconEditar($m->getId());?>
                        </td> 
                    </tr>
                    <?php
                    $i++;

...
use \Sala\control\ControlRender;
...
abstract class Factory{
    ...
    public static function getBreadCrumbs($option, $variables){
        if($option == "dashBoard"){
            ...
            $ControlMenu = new \Sala\control\ControlMenu($usuario,Factory::createDbo());
    ...
    public static function inicializarPeridos(){
        ...
        $PeriodoSession = unserialize(Factory::getSessionVar("PeriodoSession"));

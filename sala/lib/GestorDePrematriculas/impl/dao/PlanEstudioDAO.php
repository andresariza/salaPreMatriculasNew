...
use \Sala\lib\GestorDePrematriculas\interfaces\dao\IPlanEstudioDAO;
...
use \Sala\lib\GestorDePrematriculas\impl\auxiliaresPlanEstudio\GrupoImpl;
use \Sala\lib\GestorDePrematriculas\impl\auxiliaresPlanEstudio\MateriaImpl;
...
class PlanEstudioDAO implements IPlanEstudioDAO {
    ...
    private function getMateria(Entidad $m){
        $materia = new Materia();

...
$Configuration = \Sala\config\Configuration::getInstance();
...
<body>
    ...
    <div id="container" class="effect mainnav-lg <?php if(!empty($asideContainer)){?>aside-in aside-left aside-bright<?php } ?>">
        <!--NAVBAR-->
        <!--===================================================-->
        <header id="navbar" class="<?php echo ($entorno!=="produccion")?"entornoPruebas":""?>">
                    ...
                    <a href="<?php echo HTTP_SITE; ?>" class="navbar-brand">
                        ...
                        <div class="brand-title">
                            <span class="brand-text">
                                ...
                                if($entorno==="produccion"){
                                    ?>
                                    <img src="<?php echo HTTP_SITE; ?>/assets/images/logoPequeno.png" alt="btheme Logo" class="brand-icon">
                                    <?php
                                }else{
                                    ?>

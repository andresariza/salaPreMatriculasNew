...
class Configuration {
    ...
    private function __construct() {
        ...
        $this->entorno = "local";
        $this->hostName = "127.0.0.1";//desarrollo 
        $this->dbName = "sala";
        $this->dbUserName = "root";
        $this->dbUserPasswd = "";
        
        $this->HTTP_SITE = "http://localhost/salaPreMatriculasNew/sala";
        $this->HTTP_ROOT = "http://localhost/salaPreMatriculasNew";
        $this->PATH_SITE = "C:\\xampp\\htdocs\\salaPreMatriculasNew\\sala";            
        $this->PATH_ROOT = "C:\\xampp\\htdocs\\salaPreMatriculasNew";
